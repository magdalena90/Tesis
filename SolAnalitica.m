...
% Este script toma tres puntos aleatorios, calcula la solución analítica
% para el problema del elipsoide de menor volumen explicado en el Capítulo
% 4, calcula la solución con el algoritmo del elipsoide de menor
