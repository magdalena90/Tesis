function [] = ClasificarBonos()
    ...
    % Esta función lee los archivos Datos07.xlsx hasta Datos13.xlsx que
    % contienen la información de los bonos de cada año, procesa los datos,
    % manda llamar a la función CrearElipse para crear el elipsoide de
    % menor volumen para cada clase, calcula el error de predicción y
