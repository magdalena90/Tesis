function [] = ClasificarBonos()
    ...
    % Recibe matrices con puntos y etiquetas divididos en Train y Test, hace
    % los elipses correspondientes a cada grupo con los puntos de entrenamiento
    % y después clasifica los puntos de prueba.
    ...
    %     subplot(4,2,1)
    %     plot(p07(:,1),p07(:,2),'.','Color',[204,204,0]/255) % verde claro
    %     hold on
    %     f = X07(1,1)*x.^2 + 2*X07(1,2)*x.*y + X07(2,2)*y.^2;
    %     contour(x+q07(1),y+q07(2),f,[1,1],'Color',[204,204,0]/255);
    %     xlabel('a')
    ...
    % 
    %     subplot(4,2,2)
    %     plot(p08(:,1),p08(:,2),'.','Color',[102,204,0]/255) % verde
    %     hold on
    %     f = X08(1,1)*x.^2 + 2*X08(1,2)*x.*y + X08(2,2)*y.^2;
    %     contour(x+q08(1),y+q08(2),f,[1,1],'Color',[102,204,0]/255);
    %     xlabel('a')
    ...
    %     
    %     subplot(4,2,3)
    %     plot(p09(:,1),p09(:,2),'.','Color',[0,153,153]/255) % acqua
    %     hold on
    %     f = X09(1,1)*x.^2 + 2*X09(1,2)*x.*y + X09(2,2)*y.^2;
    %     contour(x+q09(1),y+q09(2),f,[1,1],'Color',[0,153,153]/255);
    %     xlabel('a')
    ...
    %     
    %     subplot(4,2,4)    
    %     plot(p10(:,1),p10(:,2),'.','Color',[0,102,204]/255) % azul
    %     hold on
    %     f = X10(1,1)*x.^2 + 2*X10(1,2)*x.*y + X10(2,2)*y.^2;
    %     contour(x+q10(1),y+q10(2),f,[1,1],'Color',[0,102,204]/255);
    %     xlabel('a')
    ...
    %     
    %     subplot(4,2,5)
    %     plot(p11(:,1),p11(:,2),'.','Color',[102,0,204]/255) % morado
    %     hold on
    %     f = X11(1,1)*x.^2 + 2*X11(1,2)*x.*y + X11(2,2)*y.^2;
    %     contour(x+q11(1),y+q11(2),f,[1,1],'Color',[102,0,204]/255);
    %     xlabel('a')
    ...
    %     
    %     subplot(4,2,6)
    %     plot(p12(:,1),p12(:,2),'.','Color',[204,0,102]/255) % rosa
    %     hold on
    %     f = X12(1,1)*x.^2 + 2*X12(1,2)*x.*y + X12(2,2)*y.^2;
    %     contour(x+q12(1),y+q12(2),f,[1,1],'Color',[204,0,102]/255);
    %     xlabel('a')
    ...
    %     
    %     subplot(4,2,7)
    %     plot(p13(:,1),p13(:,2),'.','Color',[255,128,0]/255) % naranja
    %     hold on
    %     f = X13(1,1)*x.^2 + 2*X13(1,2)*x.*y + X13(2,2)*y.^2;
    %     contour(x+q13(1),y+q13(2),f,[1,1],'Color',[255,128,0]/255);  
    %     xlabel('a')
